// WhatsApp Ping Everyone Content Script - Firefox Version
...
// Listen for messages from popup (Firefox version)
browser.runtime.onMessage.addListener(function(request, sender, sendResponse) {
    if (request.action === 'startPing') {
        pinger.startPinging(request.userCount).then(result => {
            ...
            if (result.success) {
                browser.runtime.sendMessage({ action: 'pingComplete' });
            } else {
                browser.runtime.sendMessage({ action: 'pingError', error: result.error });
            }
        });
...
console.log('WhatsApp Ping Everyone extension loaded (Firefox)');
